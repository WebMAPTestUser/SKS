...
namespace UpgradeHelpers.VB6.Gui
{
    ...
    public class ComboBoxHelper : ComboBox
    {
        ...
        private void InitializeComboBoxHelper()
        {
            ...
            this.DrawItem += new DrawItemEventHandler(ComboBoxHelper_DrawItem);
            this.SelectedIndexChanged += new EventHandler(ComboBoxHelper_SelectedIndexChanged);
            this.Click += new EventHandler(ComboBoxHelper_Click);
            this.Clicked = false;
            this._listwidth = this.Bounds.Width;
        }
        ...
        {
            if (this.ColumnEdit >= 0)
            {

                string str = (string)this.Items[this.SelectedIndex];
                string[] values = str.Split(new char[] { Convert.ToChar(this._columnSeparatorChar) });
                if (this.ColumnEdit < values.Length)
                {
                    this.Text = values[this.ColumnEdit];
                }
            }
        }
        /// <summary>
        ...
        class Comparer : IComparer<string>
        {
            ...
            private int columns;
            Dictionary<int, SortedConstants> sort = new Dictionary<int, SortedConstants>();
        ...
        public void AddItem(string Item, int Index)
        {
            ...
            int index = this.Items.Count > Index ? Index : this.Items.Count;
        ...
        private ActionConstants _action = ActionConstants.ActionClear;
        /// <summary>
            ...
            set
            {
                ...
                switch (_action)
                {
                    case ActionConstants.ActionClear:
                        ...
                        this.Text = "";
                        break;
                    case ActionConstants.ActionSearch:
                        ...
                        break;
                    case ActionConstants.ActionClearSearchBuffer:
