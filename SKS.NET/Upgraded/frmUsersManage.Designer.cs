...
namespace SKS
{
	partial class frmUsersManage
	{
		...
		public static frmUsersManage DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmUsersManage();
		...
		private string[] visualControls = new string[]{"components", "ToolTipMain", "_lstAccounts_ColumnHeader_1", "_lstAccounts_ColumnHeader_2", "_lstAccounts_ColumnHeader_3", "lstAccounts", "cmdClear", "cmdSave", "ctrlLiner1", "txtFullname", "txtPassword", "txtUsername", "cboLevel", "_Label1_2", "_Label1_0", "_Label1_1", "_Label1_3", "lblId", "Frame1", "cmdClose", "cmdEdit", "cmdDelete", "_Label1_4", "Label19", "Label4", "Image1", "Label1", "listViewHelper1"};
		//Required by the Windows Form Designer
		private System.ComponentModel.IContainer components;
		public System.Windows.Forms.ToolTip ToolTipMain;
		private System.Windows.Forms.ColumnHeader _lstAccounts_ColumnHeader_1;
		private System.Windows.Forms.ColumnHeader _lstAccounts_ColumnHeader_2;
		private System.Windows.Forms.ColumnHeader _lstAccounts_ColumnHeader_3;
