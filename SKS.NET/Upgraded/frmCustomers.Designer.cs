...
namespace SKS
{
	partial class frmCustomers
	{
		...
		public static frmCustomers DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmCustomers();
		...
		private void InitializeComponent()
		{
			...
			this.dcCustomers = new UpgradeHelpers.VB6.DB.ADO.ADODataControlHelper();
			...
			this.dcCustomers.BOFAction = UpgradeHelpers.VB6.DB.Controls.BOFActionEnum.MoveFirst;
			this.dcCustomers.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\vbsample\\SKS\\Database\\Orders.mdb;Persist Security Info=False";
			this.dcCustomers.CursorLocation = UpgradeHelpers.VB6.DB.ADO.CursorLocationEnum.adUseClient;
			this.dcCustomers.Enabled = true;
			this.dcCustomers.EOFAction = UpgradeHelpers.VB6.DB.Controls.EOFActionEnum.MoveLast;
			...
			this.dcCustomers.LockType = UpgradeHelpers.VB6.DB.ADO.LockTypeEnum.adLockOptimistic;
			...
			this.Text = "Customers";
			this.Closed += new System.EventHandler(this.frmCustomers_Closed);
		...
		{
			dcCustomers.Refresh();
			_txtField_9.DataBindings.Add("Text", dcCustomers.Recordset, "Table.Extension");
			_txtField_14.DataBindings.Add("Text", dcCustomers.Recordset, "Table.Notes");
			_txtField_10.DataBindings.Add("Text", dcCustomers.Recordset, "Table.FaxNumber");
			_txtField_8.DataBindings.Add("Text", dcCustomers.Recordset, "Table.PhoneNumber");
			_txtField_12.DataBindings.Add("Text", dcCustomers.Recordset, "Table.ContactFirstName");
			_txtField_13.DataBindings.Add("Text", dcCustomers.Recordset, "Table.ContactLastName");
			_txtField_11.DataBindings.Add("Text", dcCustomers.Recordset, "Table.ContactTitle");
			_txtField_5.DataBindings.Add("Text", dcCustomers.Recordset, "Table.City");
			_txtField_3.DataBindings.Add("Text", dcCustomers.Recordset, "Table.BillingAddress");
			_txtField_1.DataBindings.Add("Text", dcCustomers.Recordset, "Table.CompanyOrDepartment");
			_txtField_2.DataBindings.Add("Text", dcCustomers.Recordset, "Table.EmailAddress");
			_txtField_7.DataBindings.Add("Text", dcCustomers.Recordset, "Table.Country/Region");
			_txtField_6.DataBindings.Add("Text", dcCustomers.Recordset, "Table.StateOrProvince");
			_txtField_0.DataBindings.Add("Text", dcCustomers.Recordset, "Table.CompanyName");
			_txtField_4.DataBindings.Add("Text", dcCustomers.Recordset, "Table.PostalCode");
		}
		#endregion
	}
}