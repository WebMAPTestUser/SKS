...
namespace SKS
{
	partial class frmProviders
	{
		...
		public static frmProviders DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmProviders();
		...
		private void InitializeComponent()
		{
			...
			this.dcProviders = new UpgradeHelpers.VB6.DB.ADO.ADODataControlHelper();
			...
			this.dcProviders.BOFAction = UpgradeHelpers.VB6.DB.Controls.BOFActionEnum.MoveFirst;
			this.dcProviders.ConnectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\\vbsample\\SKS\\Database\\Orders.mdb;Persist Security Info=False";
			this.dcProviders.CursorLocation = UpgradeHelpers.VB6.DB.ADO.CursorLocationEnum.adUseClient;
			this.dcProviders.Enabled = true;
			this.dcProviders.EOFAction = UpgradeHelpers.VB6.DB.Controls.EOFActionEnum.MoveLast;
			...
			this.dcProviders.LockType = UpgradeHelpers.VB6.DB.ADO.LockTypeEnum.adLockOptimistic;
			...
			this.Text = "Suppliers";
			this.Closed += new System.EventHandler(this.frmProviders_Closed);
		...
		{
			dcProviders.Refresh();
			_txtField_9.DataBindings.Add("Text", dcProviders.Recordset, "Table.Extension");
			_txtField_14.DataBindings.Add("Text", dcProviders.Recordset, "Table.Notes");
			_txtField_10.DataBindings.Add("Text", dcProviders.Recordset, "Table.FaxNumber");
			_txtField_8.DataBindings.Add("Text", dcProviders.Recordset, "Table.PhoneNumber");
			_txtField_12.DataBindings.Add("Text", dcProviders.Recordset, "Table.ContactFirstName");
			_txtField_13.DataBindings.Add("Text", dcProviders.Recordset, "Table.ContactLastName");
			_txtField_11.DataBindings.Add("Text", dcProviders.Recordset, "Table.ContactTitle");
			_txtField_5.DataBindings.Add("Text", dcProviders.Recordset, "Table.City");
			_txtField_2.DataBindings.Add("Text", dcProviders.Recordset, "Table.EmailAddress");
			_txtField_7.DataBindings.Add("Text", dcProviders.Recordset, "Table.Country/Region");
			_txtField_6.DataBindings.Add("Text", dcProviders.Recordset, "Table.StateOrProvince");
			_txtField_0.DataBindings.Add("Text", dcProviders.Recordset, "Table.ProviderName");
			_txtField_4.DataBindings.Add("Text", dcProviders.Recordset, "Table.PostalCode");
			_txtField_1.DataBindings.Add("Text", dcProviders.Recordset, "Table.PaymentTerms");
		}
		#endregion
	}
}