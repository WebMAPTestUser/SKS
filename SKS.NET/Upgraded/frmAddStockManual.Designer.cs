...
namespace SKS
{
	partial class frmAddStockManual
	{
		...
		public static frmAddStockManual DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmAddStockManual();
		...
		private string[] visualControls = new string[]{"components", "ToolTipMain", "cmdSave", "cmdClose", "_sbStatusBar_Panel1", "sbStatusBar", "txtUnit", "txtProductName", "txtQuantityPerUnit", "_txtValues_2", "_txtValues_1", "_txtValues_0", "cmdProducts", "txtName", "txtCode", "Label4", "Label5", "Frame1", "_lvProducts_ColumnHeader_1", "_lvProducts_ColumnHeader_2", "_lvProducts_ColumnHeader_3", "_lvProducts_ColumnHeader_4", "_lvProducts_ColumnHeader_5", "_lvProducts_ColumnHeader_6", "_lvProducts_ColumnHeader_7", "lvProducts", "lblNewQuantity", "Label10", "Label9", "Label8", "Label7", "Label6", "Label1", "Label2", "Label3", "txtValues", "listViewHelper1"};
		...
		private void InitializeComponent()
		{
			...
			this.Closed += new System.EventHandler(this.frmAddStockManual_Closed);
