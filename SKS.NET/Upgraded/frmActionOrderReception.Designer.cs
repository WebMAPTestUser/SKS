...
namespace SKS
{
	partial class frmActionOrderReception
	{
		...
		public static frmActionOrderReception DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmActionOrderReception();
		...
		public UpgradeHelpers.Windows.Forms.DataGridViewFlex fgDetails;
		...
		private void InitializeComponent()
		{
			...
			this.Closed += new System.EventHandler(this.frmActionOrderReception_Closed);
