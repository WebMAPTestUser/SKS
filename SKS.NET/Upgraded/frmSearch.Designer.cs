...
namespace SKS
{
	partial class frmSearch
	{
		...
		public static frmSearch DefInstance
		{
			get
			{
				if (m_vb6FormDefInstance == null || m_vb6FormDefInstance.IsDisposed)
				{
					...
					m_vb6FormDefInstance = new frmSearch();
		...
		private string[] visualControls = new string[]{"components", "ToolTipMain", "cmdClose", "cmdSearch", "ctrlLiner1", "cboSrchBy", "txtSrchStr", "Label20", "Label19", "Image3", "Shape2", "Label1", "lblSrchBy"};
		...
		public UpgradeHelpers.VB6.Gui.ShapeHelper Shape2;
